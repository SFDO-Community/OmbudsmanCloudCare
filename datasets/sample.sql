...
INSERT INTO "Case" VALUES('5001100000HCo4OAAT','false','Education','Social Media','For training purposes, this is what a case would look like when created before we know who the Sailor is to attach it to. It gets attached to the Name Unknown (DO NOT DELETE) sailor, who is the placeholder for all cases before we can connect them to the right sailor.','New','Example of a Case where we didn''t get sailor''s name','','Medium','0011100001vbeseAAA','0031100001fMQLTAA4','','a0q11000005WC6rAAG',NULL);
